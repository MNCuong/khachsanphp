...
<div class = "content px-3 ">
        ...
        <form action="themphong_controller.php" method="POST" class ="pb-5 pt-3 mb-3  mx-auto" style="width:70%" enctype="multipart/form-data">
            <div class = "my-3">
                <div class="row">
            ...
            <div class = "mt-3">
                ...
                <button><a href="danhsachphong.php">Hủy</a></button>
            </div>
    </form>
