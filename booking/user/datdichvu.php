    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="datdichvu_controller.php" method="post">
                        <div class="mb-3">
                        ...
                        <button class="btn btn-primary" name="btnSubmit"><a href="index.php" style="color:#fff;text-decoration:none">Hủy</a></button>
                    </form>
                </div>
            </div>
        </div>
